...
"""
This is used to create fake data. Not needed.
...
p = subprocess.Popen("grep DM %s"%ephemeris, shell=True, stdin=PIPE, stdout=PIPE, stderr=subprocess.STDOUT, close_fds=True)
...
#Got rid of the DM0=DM0 in the argument below
gt.get_TOAs(DM0=DM0)
...
#os.system("python pptoas.py -d example.meta -m example-fit.spl -o example.tim")
#print("System command performed to write timfile")
