...
import sys
### This version of the script has been made specifically for submitting a batch job for each observation in J0347
...
pulsar = "J0437-4715" #input("Input the pulsar that you want to analyse: ")
obs = sys.argv[1]
